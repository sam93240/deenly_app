class Invocation {
  ...
  final String source;
  const Invocation({required this.arabic, required this.phonetic, required this.translation, required this.source});
}
...
class InvocationCategory {
  ...
  const InvocationCategory({required this.id, required this.title, required this.emoji, required this.description, required this.invocations});
}
